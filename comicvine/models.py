...
class ComicVineIssue(models.Model):
...
class ComicVinePerson(models.Model):
    comicvine_id = models.PositiveIntegerField(unique=True)
    name = models.CharField(max_length=500)
    api_detail_url = models.URLField(max_length=500, blank=True)
    comicvine_url = models.URLField(max_length=500, blank=True)
...
class ComicVineCharacter(ComicVineNamedEntity):
    pass


class ComicVineTeam(ComicVineNamedEntity):
    pass


class ComicVineLocation(ComicVineNamedEntity):
    pass


class ComicVineConcept(ComicVineNamedEntity):
    pass


class ComicVineObject(ComicVineNamedEntity):
    pass


class ComicVineStoryArc(ComicVineNamedEntity):
    pass


class ComicVineCreditRole(models.Model):
...
class ComicVineIssuePersonCredit(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                name="unique_comicvine_issue_person_role_credit",
            )
        ]
...
class ComicVineVolumePersonCredit(models.Model):
    volume = models.ForeignKey(
        ComicVineVolume,
        on_delete=models.CASCADE,
        related_name="person_credits",
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                name="unique_comicvine_volume_person_credit",
            )
        ]
...
class ComicVineIssueRelationship(models.Model):
...
class ComicVineIssueCharacterLink(ComicVineIssueRelationship):
    issue = models.ForeignKey(
        ComicVineIssue,
        on_delete=models.CASCADE,
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                name="unique_comicvine_issue_character_relation",
            )
        ]
...
class ComicVineIssueTeamLink(ComicVineIssueRelationship):
    issue = models.ForeignKey(
        ComicVineIssue,
        on_delete=models.CASCADE,
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                name="unique_comicvine_issue_team_relation",
            )
        ]
...
class ComicVineIssueLocationLink(ComicVineIssueRelationship):
    issue = models.ForeignKey(
        ComicVineIssue,
        on_delete=models.CASCADE,
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                name="unique_comicvine_issue_location_relation",
            )
        ]
...
class ComicVineIssueConceptLink(ComicVineIssueRelationship):
    issue = models.ForeignKey(
        ComicVineIssue,
        on_delete=models.CASCADE,
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                name="unique_comicvine_issue_concept_relation",
            )
        ]
...
class ComicVineIssueObjectLink(ComicVineIssueRelationship):
    issue = models.ForeignKey(
        ComicVineIssue,
        on_delete=models.CASCADE,
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                name="unique_comicvine_issue_object_relation",
            )
        ]
...
class ComicVineIssueStoryArcLink(ComicVineIssueRelationship):
    issue = models.ForeignKey(
        ComicVineIssue,
        on_delete=models.CASCADE,
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                name="unique_comicvine_issue_story_arc_relation",
            )
        ]
...
class ComicVineIssueAssociatedImage(models.Model):
    issue = models.ForeignKey(
        ComicVineIssue,
        on_delete=models.CASCADE,
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                name="unique_comicvine_issue_associated_image_position",
            )
        ]
