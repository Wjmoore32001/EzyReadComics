...
class StyledUserCreationForm(UserCreationForm):
    email = forms.EmailField(
        ...
        help_text="Optional. You can leave this blank. It may be used later for account recovery, but no verification email is required right now.",
    )
    ...
    def clean_website(self):
        ...
        if website:
            raise forms.ValidationError("There was a problem creating this account. Please try again.")
